...
public class ImportExcelHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_SELECTION) ISelection selection) {
		...
		try {
			...
			MessageDialog.openError(shell, "Import failed",
					"Failed to import from Excel! Make sure to close file before import.");
		}
	}
	...
	private void removeDeletedEntities(Workbook workbook, Package modelPackage) {
		...
		Collection<Interface> interfaces = EcoreUtil.getObjectsByType(modelPackage.allOwnedElements(),
